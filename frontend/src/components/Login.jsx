  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (activeTab === "student" && user.role === "staff") {
        setError("Please use the Staff tab to login as staff.");
        setLoading(false);
        return;
      }
      ...
      <div className="login-card">
        ...
        <div className="login-logo-wrap">
          ...
          <div>
            ...
            <p className="login-tagline">Intelligent Campus Management Platform</p>
          </div>
        </div>
        ...
        <p className="login-tab-hint">
          {activeTab === "student"
            ...
            : "Sign in to access the faculty management console"}
        </p>
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          >
            {loading ? (
              ...
              <>
                Sign In as {activeTab === "student" ? "Student" : "Staff"}
